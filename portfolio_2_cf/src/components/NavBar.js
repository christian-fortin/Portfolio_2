  ...
  return (
    <header className="header">
      ...
      <ul className="main-nav">
          ...
          <a href="https://docs.google.com/document/d/1-TK6B6LmP3zYMHRB08BHtF36oHlUjOmF-CFiMHY7oQk/edit" target="_blank" rel="noopener noreferrer" ><li className='nav-li'>Resume</li></a>
