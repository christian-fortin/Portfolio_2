        ...
        <div class="flip-card">
          <div class="flip-card-inner">
            <div class="flip-card-front">
              <img
                src="images/xboxController.png"
                alt="xboxController"
                className="card2col3ImageCover-xbox"
              />
            </div>
            <div class="flip-card-back">
              <h1 className="cardHeader">Video Games</h1>
              <p className="cardParagraph">
                Video Games are something I have always loved, ranging from
                computer games to xbox games and switch games. The first games
                I started with were Age of Mythology for PC and Pokemon for
                Game Boy Color. I moved on to Call Of Duty and Halo, then to
                FIFA. Recently I have been playing Mario Kart on my switch and
                am very close to beating the game on all difficulties.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="flip-card">
          <div class="flip-card-inner">
            <div class="flip-card-front">
              <img
                src="images/chessGame.gif"
                alt="chessPuzzleCover"
                className="card2col3chessImageCover"
              />
            </div>
            <div class="flip-card-back">
      ...
      <div className="colum3-AboutMe">
          ...
          <div class="flip-card-inner">
            <div class="flip-card-front">
              <img
                ...
                alt="Big Sky"
                className="card1col3ImageCover-bigsky"
              />
            </div>
            <div class="flip-card-back">
              <h1 className="cardHeader">Skiing</h1>
              <p className="cardParagraph">
                Skiing has always been a big part of my life. While in middle
        ...
        <div class="flip-card">
          <div class="flip-card-inner">
            <div class="flip-card-front">
              <img
                src="images/magellanShips.jpg"
                alt="Magellan ships"
                className="card3col3ImageCover-history"
              />
            </div>
            <div class="flip-card-back">
              <h1 className="cardHeader">History</h1>
              <p className="cardParagraph">
                I think I can trace back to Age of Mythology for my love of
